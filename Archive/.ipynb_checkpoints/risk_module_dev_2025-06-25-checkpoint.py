...
max_betas = calc_max_factor_betas(
...
# helpers_compare.py  –  robust diff utilities
import pandas as pd
...
# 1) apply the delta and recompute
delta = {"TW": +0.05, "PCTY": -0.02}
_, risk_new, beta_new = simulate_portfolio_change(
    weights, delta,
    risk_config,
    config["start_date"], config["end_date"],
    stock_factor_proxies
...
print(cmp_beta.to_string(formatters={
        "Old": _fmt_pct, "New": _fmt_pct, "Δ": _fmt_pct,
        "Max Beta": "{:.2f}".format,
...
print("\n✅  Max-return, risk-constrained weights:\n")
